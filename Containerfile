...
RUN dnf -y install cockpit cockpit-ws cockpit-podman git tree tailscale podman podman-compose NetworkManager-wifi && dnf clean all && systemctl enable cockpit.socket
